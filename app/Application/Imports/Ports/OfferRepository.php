...
{
    /**
     * Idempotently creates or updates an Offer by (supplier, external_id) — C2.
     *
    ...
    /**
     * Atomically decrements available_units. Returns false if available_units is already 0 — C4/P4.
     */
